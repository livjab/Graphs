...
# set up traversal graph of each room
traversal_graph = {}
for room in roomGraph:
  traversal_graph[room] = (roomGraph[room][1])

# replace known directions with '?'
for room in traversal_graph:
  for direction in traversal_graph[room]:
    traversal_graph[room][direction] = '?'


traversalPath = []

# direction to start heading in
